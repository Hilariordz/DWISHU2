                    ...
                    <nav className="flex gap-4">
                        {auth.user ? (
                            <Link
                                ...
                                className="rounded-md px-4 py-2 text-white bg-white/10 backdrop-blur-sm border border-white/20 transition hover:bg-white/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-white"
                            >
                                Dashboard
                            </Link>
                        ) : (
